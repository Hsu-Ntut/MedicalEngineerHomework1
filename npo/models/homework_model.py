...
from typing import Type, List, Union, Optional, Any, Callable, Tuple
import torch
    ...
    def __init__(
        ...
        if proj:
            self.proj = nn.Sequential(
                ...
                nn.Flatten(),
                nn.Linear(256 * block.expansion * 4, 256 * block.expansion * 4),
                nn.BatchNorm1d(256 * block.expansion * 4),
                nn.ReLU(),
                nn.Linear(256 * block.expansion * 4, 256)
            )
